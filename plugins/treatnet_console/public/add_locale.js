...
/* look at @kbn/i18n/src/core/locales */
function treatnetConsoleAddLocaleData(localeData) {
  ...
  treatnetConsoleAddLocaleData({
    ...
    fields: {
      ...
      'week': {
        ...
        'relative': {'0': 'w tym tygodniu', '1': 'w przyszłym tygodniu', '-1': 'w zeszłym tygodniu'},
        'relativeTime': {
          'future': {
            'one': 'za {0} tydzień',
            'few': 'za {0} tygodnie',
      ...
      'week-short': {
        ...
        'relativeTime': {
          ...
          'past': {'one': '{0} tydz. temu', 'few': '{0} tyg. temu', 'many': '{0} tyg. temu', 'other': '{0} tyg. temu'}
        }
      },
      'day': {
        'displayName': 'dzień',
        'relative': {'0': 'dzisiaj', '1': 'jutro', '2': 'pojutrze', '-2': 'przedwczoraj', '-1': 'wczoraj'},
        'relativeTime': {
          'future': {
            'one': 'za {0} dzień',
            'few': 'za {0} dni',
      ...
      'minute-short': {
        ...
        'relativeTime': {
          'future': {
            ...
            'many': 'za {0} min',
            'other': 'za {0} min'
          }, 'past': {'one': '{0} min temu', 'few': '{0} min temu', 'many': '{0} min temu', 'other': '{0} min temu'}
        }
      },
      'second': {
        'displayName': 'sekunda',
      ...
      'second-short': {
        ...
        'relativeTime': {
          'future': {
            ...
            'many': 'za {0} sek.',
            'other': 'za {0} sek.'
          }, 'past': {'one': '{0} sek. temu', 'few': '{0} sek. temu', 'many': '{0} sek. temu', 'other': '{0} sek. temu'}
        }
      }
    }
  });
  treatnetConsoleAddLocaleData({ locale: "pl-PL", parentLocale: "pl" });
});
